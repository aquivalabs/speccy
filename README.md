...
| **Wrap-up** | User reviews | Summary, a decision log distilled from critique decisions, deferred-feedback list, retrospective. The branch is handed back for your review — Speccy doesn't merge or certify it. |
