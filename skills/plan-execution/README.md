...
This skill is a thin, opinionated composition on top of the `Workflow` tool rather than a replacement for it. It exists because Claude Code ships the *primitives* for multi-agent work but leaves the *build pipeline* to the project.
