...
1. **Summary**: what was built, how many critique/review rounds ran, what changed, and that the branch is ready for review. Name the last round's fixes as the part no lens reviewed: they were applied after the final review, gated, and residue-checked, and nothing independent read them (see Phase 4). It is a line, and it tells the user where to look hardest in the diff.
