...
Write findings to the file you are given. For each: the exact suppression and its location, what it silences, and either the non-suppressing fix or precisely what a watertight justification would have to establish. If the change adds no suppressions, say so.
